...
vim.keymap.set('n', '<leader>c', ':!gcc % -o %:r && ./%:r<cr>', { desc = 'compile & run c file' })
...
vim.keymap.set('t', '<Leader>q', '<C-\\><C-n>', { noremap = true, silent = true })
...
vim.opt.relativenumber = true -- Relative line numbers (optional)
